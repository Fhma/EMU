...
public class EMUExecutionTests extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		IModel model = createEmfModel("Model", EMUExecutionTests.class.getResource("resources/petrinet_example_1.xmi").getPath(),
	...
	private int getMatrixSize(HashMap<String, Integer> map) {
		int size = 0;
		Iterator it = map.entrySet().iterator();
		while (it.hasNext())
		{
			Map.Entry pair = (Map.Entry) it.next();
			size += (int) pair.getValue();
			it.remove();
		}
		return size;
	}
	...
	public void test_invalid_2() throws Exception {
		...
		module.execute();
		assertEquals(0, getMatrixSize(module.getMutationsIndexer()));
	}
	...
	public void test_valid_2() throws Exception {
		...
		module.execute();
		assertEquals(1, getMatrixSize(module.getMutationsIndexer()));
	}
	...
	public void test_valid_3() throws Exception {
		...
		module.execute();
		assertEquals(2, getMatrixSize(module.getMutationsIndexer()));
	}
